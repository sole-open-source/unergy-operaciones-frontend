...
const api = new Function(src + '\nreturn { toIsoDate, contratoActivo, checkDateOverlap, findReplacementContract, validateContractUniqueness, conflictosAtribucion };')()
const { toIsoDate, checkDateOverlap, findReplacementContract, validateContractUniqueness, conflictosAtribucion } = api
