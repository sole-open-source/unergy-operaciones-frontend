...
const routes = [
  ...
  { path: '/liquidaciones/minigranjas', name: 'LiquidacionesMinigranjas', component: () => import('@/views/Liquidaciones/LiquidacionesListView.vue'), props: { tipoProyecto: 'minigranja' }, meta: { roles: ['admin', 'liquidaciones'] } },
